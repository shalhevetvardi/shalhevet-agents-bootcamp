...
**עודכן:** 18-09-2026 | **גרסה חיה:** v0.4.3 | **ריפו:** `shalhevet-agents-bootcamp`
...
- **מייל broadcast** (בשחרור v0.4.0): "ה-rebuild תוקן - התקינו את הגרסה המעודכנת" נשלח/מוכן ל-45 תלמידים פעילים (דרך סקיל `kaas:broadcast`). ל-v0.4.3 לא נשלח broadcast (תיקון מטא-דאטה, הקישור לא השתנה) - ההחלטה אם להודיע לתלמידים שנתקלו בדחייה פתוחה אצל שלהבת.
