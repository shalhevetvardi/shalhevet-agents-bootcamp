...
**עודכן:** 08-08-2026 | **גרסה חיה:** v0.4.1 | **ריפו:** `shalhevet-agents-bootcamp`
...
## קבצים (נתיבים מלאים)
- `skills/rebuild-plugin/SKILL.md` - הלוגיקה (v0.4.1). **מקור-האמת - עורכים כאן.**
- `skills/rebuild-plugin/.claude-plugin/plugin.json` - version 0.4.1.
